...
save_path = "/content/drive/MyDrive/MT5_Greeklish/"
...
# ================ Fine-Tuning =================
model = MT5ForConditionalGeneration.from_pretrained("google/mt5-{}".format(version))
tokenizer = MT5Tokenizer.from_pretrained("google/mt5-{}".format(version))
# model = T5ForConditionalGeneration.from_pretrained("google/mt5-base")
# tokenizer = ByT5Tokenizer.from_pretrained("google/mt5-base")
...
for epoch in range(1, epochs + 1):
    ...
    if not best_loss:
        ...
        tokenizer.save_pretrained(save_path + "MT5_{}_{}_samples".format(version, data_size))
        model.save_pretrained(save_path + "MT5_{}_{}_samples".format(version, data_size))
