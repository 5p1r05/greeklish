...
greek_path = "data/artificial/greek/"
greeklish_path = "data/artificial/greeklish/"

# import data
with open(greek_path + "greek_europarl_training_100k.txt", "r", encoding="utf-8") as file:
    train_y = []
    for line in file:
        train_y.append(line)
with open(greeklish_path + "greeklish_europarl_training_100k.txt", "r", encoding="utf-8") as file:
    train_x = []
    for line in file:
        train_x.append(line)
